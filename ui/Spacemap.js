class Spacemap {
  ...
  genMapsBox() {
    this.mapsWrapper = ElUtils.createBox("spacemap_ov_map_wrapper");
  ...
  genControlPanel() {
    ...
    const targetWrapper = ElUtils.createBox("spacemap_ov_control_target");
    ...
    const targetVisualWrapper = ElUtils.createBox(
  ...
  genMaps() {
    ...
    MAP_OVERVIEW_LIST[this.showcasedSector].forEach((map, i) => {
      ...
      const mapNode = ElUtils.createBox("map_representation");
